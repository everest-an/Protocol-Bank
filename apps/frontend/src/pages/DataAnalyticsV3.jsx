        ...
        <div className="flex-1">
          ...
          <div className="relative mt-4 max-w-md">
            ...
            <input 
              ...
              className="pl-10 pr-4 py-2 w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm transition-colors"
            />
          </div>
        </div>
